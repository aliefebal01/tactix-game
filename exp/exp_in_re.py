import os
import numpy as np
from scripts_1.train_in_re import TrainAndPlot_in_re
...
def main():    
    ...
    experiment_mcts2 = TrainAndPlot_in_re(env_size=3, n_episodes=1000000, max_t=1000, batch_sizes=[128], layers= [[128,128, 128]],
