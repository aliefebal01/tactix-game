...
def main():
    ...
    pretrained_model_path_30 = os.path.join(
        ...
        "models",
        "network_hl_128_128_128_gamma_0.70_bs_128_tufq_100_mcts_iter_50_mcts_lr_0.4_wr_30_tr_-10862.pth"
    )
    print("training a small model pretrained with another dqn")
