...
def main():
    ...
    experiment_mcts = TrainAndPlot_without_opp_move_dr_re_attention(n_episodes=100000, max_t=1000, batch_sizes=[256], layers= [[256, 256, 256, 256, 256]],
    ...
    print("trying out dropout medium and residual connection with attention")
