...
def main():
    ...
    experiment_mcts = TrainAndPlot_without_opp_move_attention_mcts2(n_episodes=250000, max_t=1000, batch_sizes=[256], layers= [[256, 256, 256, 256, 256]],
    ...
    print("training medium with attention for 250k episodes")
