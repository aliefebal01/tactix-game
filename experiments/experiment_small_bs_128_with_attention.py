...
def main():
    ...
    pretrained_model_path_42 = os.path.join(
        project_root,
        "training_results",
        "training_results_5x5_with_attention_mcts2",
        "models",
        "network_hl_128_128_128_gamma_0.70_bs_128_tufq_100_mcts_iter_25_mcts_lr_0.4_wr_42_tr_-6372.pth"
    )
    ...
    pretrained_model_path_28 = os.path.join(
        project_root,
        "training_results",
        "training_results_5x5_with_attention_mcts2",
        "models",
        "network_hl_128_128_128_gamma_0.70_bs_128_tufq_100_mcts_iter_50_mcts_lr_0.4_wr_28_tr_-7041.pth"
    )
