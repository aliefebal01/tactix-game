...
def main():
    ...
    experiment_mcts2 = TrainAndPlot_without_opp_move_attention_in_re_mcts2(n_episodes=250000, max_t=1000, batch_sizes=[128], layers= [[128,128,128]],
    ...
    print("training small with attention and intermediate rewards for 250k episodes")
