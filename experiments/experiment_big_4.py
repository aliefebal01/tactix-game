...
def main():
    ...
    experiment_mcts = TrainAndPlot_without_opp_move_dr_re(n_episodes=100000, max_t=1000, batch_sizes=[512], layers= [[512, 512, 512, 512, 512, 512, 512]],
    ...
    print(" Trying out dropout and residual connection without attention")
