...
def main():
    ...
    experiment_mcts2 = TrainAndPlot_end_game_attention(n_episodes=500000, max_t=1000, batch_sizes=[1024], layers= [[256, 256, 256, 256, 256]],
    ...
    print("training medium model end game last 10 pieces low mcts iteration big batch size")
