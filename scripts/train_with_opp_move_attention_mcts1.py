...
from tactix.tactixEnvironment_with_opp_mcts1 import TactixEnvironment
...
class TrainAndPlot_with_opp_move_attention_mcts1:
    def __init__(self,
                env_size = 5,
                n_episodes=100000, 
                max_t=1000, 
        ...
        self.env = env if env else TactixEnvironment(board_size=env_size, mcts_iteration=mcts_iteration, mcts_lr=mcts_lr)
    ...
    def run_experiments(self):
        ...
        save_dir = os.path.join(base_dir, f"training_results_{self.env.game.height}x{self.env.game.height}_s'_after_opponent_with_attention_mcts1")
