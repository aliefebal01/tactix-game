...
class TrainAndPlot_without_opp_move_attention_mcts1:
    def __init__(self,
                env_size = 5,
                n_episodes=100000, 
                max_t=1000, 
    ...
    def run_training(self, layer_structure, gamma, models_dir, batch_size, pretrained_model_path=None):
        ...
        for episode in progress_bar:
            ...
            mcts_agent = MCTSAgent(player=-1, iterations=self.mcts_iteration, exploration_weight=self.mcts_lr)
    ...
    def run_experiments(self, pretrained_model_path=None):
        ...
        save_dir = os.path.join(base_dir,f"training_results_{self.env.game.height}x{self.env.game.height}_randomopponent_s'_after_agent_withattention_mcts1")
