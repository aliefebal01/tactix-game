...
class TrainAndPlot_without_opp_move_attention_in_re_mcts2:
    def __init__(self,
                env_size = 5,
                n_episodes=100000, 
                max_t=1000, 
    ...
    def run_experiments(self, pretrained_model_path=None):
        ...
        save_dir = os.path.join(base_dir,f"training_results_{self.env.game.height}x{self.env.game.height}_with_attention_in_re_mcts2")
