...
from scripts.dqn_agent_dr_re_attention import DQNAgent
...
from tactix.tactix_Environment_end_game import TactixEnvironment
...
class TrainAndPlot_without_opp_move_dr_re_attention:
    def __init__(self,
                env_size = 5,
                n_episodes=100000, 
                max_t=1000, 
