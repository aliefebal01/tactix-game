...
from scripts_1.dqn_agent_attention import DQNAgent
...
class TrainAndPlot_opp_trans_attention:
    def __init__(self,
                env_size = 5,
                n_episodes=100000, 
                max_t=1000, 
    ...
    def run_experiments(self, pretrained_model_path=None):
        ...
        save_dir = os.path.join(base_dir,f"training_results_{self.env.game.height}x{self.env.game.height}_opp_trans_attention")
