...
from scripts_1.dqn_agent import DQNAgent
...
class TrainAndPlot_opp_trans:
    ...
    def run_experiments(self, pretrained_model_path=None):
        ...
        save_dir = os.path.join(base_dir,f"training_results_{self.env.game.height}x{self.env.game.height}_opp_trans")
