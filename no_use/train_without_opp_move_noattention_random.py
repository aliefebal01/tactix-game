...
class TrainAndPlot_without_opp_move_noattention_random:
    def __init__(self,
                env_size = 5,
                n_episodes=100000, 
                max_t=1000, 
    ...
    def run_experiments(self):
        ...
        save_dir = os.path.join(base_dir,f"training_results_{self.env.game.height}x{self.env.game.height}_randomopponent_s'_after_agent_noattention")
